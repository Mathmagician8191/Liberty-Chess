Any file that does not state otherwise and is not listed as an exception here below is part of liberty chess and copyright (c) 2022 the liberty chess authors.
