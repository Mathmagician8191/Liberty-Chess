...
impl HelpPage {
  ...
  pub const fn description(self) -> &'static str {
    match self {
      ...
      Self::Elephant => "The Elephant moves like a Mann, but is immune to capture except by a Pawn, another Elephant or a King.",
      Self::Obstacle => "The Obstacle can teleport to any empty square on the board, but cannot capture other pieces.",
      Self::Wall => "The Wall moves like the Obstacle, but is immune to capture except by a Pawn, Elephant or King",
