...
impl HelpPage {
  ...
  pub const fn description(self) -> &'static str {
    match self {
      Self::PawnForward => "The pawn (p) moves one square forward.",
      ...
      Self::Knight => "The Knight (n) jumps a set number of squares in each direction, including over other pieces.",
      Self::Bishop => "The Bishop (b) moves diagonally, but cannot go past another piece. The Bishop is confined to squares of the same colour it started on.",
      Self::Rook => "The Rook (r) moves horizontally or vertically, but cannot go past another piece.",
      Self::Queen => "The Queen (q) moves as the combination of the Bishop and the Rook.",
      Self::King => "The King (k) moves one square in any direction, and has a special move called castling (covered later). Putting the King in a position where it cannot escape is the object of the game.",
      Self::Archbishop => "The Archbishop (a) moves as the combination of the Bishop and the Knight.",
      Self::Chancellor => "The Chancellor (c) moves as the combination of the Rook and the Knight.",
      Self::Camel => "The Camel (l) moves like the Knight, only a different number of squares to it. The Camel is confined to squares of a the same colour it started on.",
      Self::Zebra => "The Zebra (z) moves like the Knight, only a different number of squares to it.",
      Self::Mann => "The Mann (x) moves one square in any direction.",
      Self::Nightrider => "The Nightrider (i) can make multiple knight jumps at once in the same direction, but cannot go past another piece on one of the knight-jump destination squares.",
      Self::Champion => "The Champion (h) can go 1 or 2 spaces in any direction, and can jump over other pieces. However, it cannot make a Knight move.",
      Self::Centaur => "The Centaur (u) moves as the combination of the Knight and the Mann.",
      Self::Amazon => "The Amazon (m) moves as a combination of the Queen and the Knight.",
      Self::Elephant => "The Elephant (e) moves like a Mann, but is immune to capture except by a Pawn, another Elephant or a King.",
      Self::Obstacle => "The Obstacle (o) can teleport to any empty square on the board, but cannot capture other pieces.",
      Self::Wall => "The Wall (w) moves like the Obstacle, but is immune to capture except by a Pawn, Elephant or King",
